...
<li>apex_application_admin.c_app_available_devs_only - Application only available to developers.</li>
<li>apex_application_admin.c_app_restricted_access - Application only available to users in <code class="codeph">p_allowed_users_list</code>.</li>
<li>apex_application_admin.c_app_unavailable - Application unavailable. Message shown in <code class="codeph">p_message</code>.</li>
<li>apex_application_admin.c_app_unavailable_redirect - Application unavailable. Redirected to URL provied in <code class="codeph">p_redirect_url</code>.</li>
<li>apex_application_admin.c_app_unavailable_show_plsql - Application unavailable. Message shown from PL/SQL block in <code class="codeph">p_plsql_code</code>.</li>
</ul></td>
</tr>
<tr data-align="left" data-valign="top">
...
<li>RUN_ONLY - Users can only run the application. Developers cannot edit the application.</li>
</ul>
</div></td>
</tr>
</tbody>
