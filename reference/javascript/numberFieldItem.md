<!-- Source: https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/numberFieldItem.html -->
...
The numberFieldItem interface is used to access the properties and methods of the Number Field item. You get access to the numberFieldItem interface with the [apex.item](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/apex.item.html) function when passed the item id (name) of a Number Field item.
...
Inherited From:
- [item#element](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#element)
...
Inherited From:
- [item#id](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#id)
...
Overrides:
- [item#item_type](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#item_type)
...
Inherited From:
- [item#node](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#node)
...
Inherited From:
- [item#value](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#value)
...
Inherited From:
- [item#disable](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#disable)
...
Overrides:
- [item#displayValueFor](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#displayValueFor)
...
Inherited From:
- [item#enable](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#enable)
...
Return the current value of the item as a JavaScript number. If the value is not a valid number returns NaN. This is useful when working with numbers because the [item#getValue](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#getValue) method always returns a string.
...
Inherited From:
- [item#getValidationMessage](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#getValidationMessage)
...
Inherited From:
- [item#getValidity](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#getValidity)
...
Overrides:
- [item#getValue](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#getValue)
...
Inherited From:
- [item#hasDisplayValue](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#hasDisplayValue)
...
Inherited From:
- [item#hide](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#hide)
...
Overrides:
- [item#isChanged](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#isChanged)
...
Inherited From:
- [item#isDisabled](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#isDisabled)
...
Inherited From:
- [item#isEmpty](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#isEmpty)
...
Inherited From:
- [item#setFocus](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#setFocus)
...
Inherited From:
- [item#setStyle](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#setStyle)
...
Overrides:
- [item#setValue](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#setValue)
...
Inherited From:
- [item#show](https://docs.oracle.com/en/database/oracle/apex/24.2/aexjs/item.html#show)
