# Oracle APEX 24.2 — Capability Map

**Purpose:** a task-oriented index of what APEX 24.2 can actually do, so you look up
...
> **Version note:** the offline PL/SQL + JavaScript references are Oracle APEX **24.2**
> (matching the company instance). The **APEXlang** reference below is **26.1** — Oracle
> ships no APEXlang API reference for 24.2 — so treat it as forward-looking, not a 24.2 API.
...
| LDAP authentication / directory lookups | `APEX_LDAP` | [plsql](reference/plsql/040-APEX_LDAP.md) |
| Create/verify JSON Web Tokens (JWT) | `APEX_JWT` | [plsql](reference/plsql/038-APEX_JWT.md) |
| Escape strings to prevent XSS / unsafe output | `APEX_ESCAPE` | [plsql](reference/plsql/026-APEX_ESCAPE.md) |

## Sessions & session state

| To… | Use | Ref |
|---|---|---|
| Configure/create APEX sessions (e.g. for jobs, REST) | `APEX_SESSION` | [plsql](reference/plsql/051-APEX_SESSION.md) |
| Read/assign session state (item values) | `APEX_SESSION_STATE` | [plsql](reference/plsql/052-APEX_SESSION_STATE.md) |
| Get/set session state + many general utilities | `APEX_UTIL` | [plsql](reference/plsql/059-APEX_UTIL.md) |
...
| To… | Use | Ref |
|---|---|---|
| Execute SQL/DML against any data source (the modern abstraction) | `APEX_EXEC` | [plsql](reference/plsql/027-APEX_EXEC.md) |
...
| Generate synthetic/test data | `APEX_DG_DATA_GEN` | [plsql](reference/plsql/024-APEX_DG_DATA_GEN.md) |
| Sync rows between tables / from REST sources (instant or scheduled) | `APEX_REST_SOURCE_SYNC` | [plsql](reference/plsql/049-APEX_REST_SOURCE_SYNC.md) |
| Use Oracle Locator / Spatial features | `APEX_SPATIAL` | [plsql](reference/plsql/054-APEX_SPATIAL.md) |
| Parse/generate JSON | `APEX_JSON` | [plsql](reference/plsql/037-APEX_JSON.md) |

## Web services & integration

| To… | Use | Ref |
|---|---|---|
| Call REST/SOAP web services from PL/SQL | `APEX_WEB_SERVICE` | [plsql](reference/plsql/060-APEX_WEB_SERVICE.md) |
| Download files over HTTP | `APEX_HTTP` | [plsql](reference/plsql/030-APEX_HTTP.md) |
| Invoke extension applications | `APEX_EXTENSION` | [plsql](reference/plsql/029-APEX_EXTENSION.md) |
...
| To… | Use | Ref |
|---|---|---|
| Send email from an application | `APEX_MAIL` | [plsql](reference/plsql/041-APEX_MAIL.md) |
| PWA push notifications (subscribe/send) | `APEX_PWA` (server), `apex.pwa` (client) | [plsql](reference/plsql/047-APEX_PWA.md) · [js](reference/javascript/apex.pwa.md) |
...
| To… | Use | Ref |
|---|---|---|
| String split/join, table-of-string types, manipulation | `APEX_STRING`, `APEX_STRING_UTIL` | [plsql](reference/plsql/055-APEX_STRING.md) · [plsql](reference/plsql/056-APEX_STRING_UTIL.md) |
| Convert Markdown → HTML (in the database) | `APEX_MARKDOWN` | [plsql](reference/plsql/042-APEX_MARKDOWN.md) |
| Translate messages / localize text | `APEX_LANG` (server), `apex.lang` (client) | [plsql](reference/plsql/039-APEX_LANG.md) · [js](reference/javascript/apex.lang.md) |
...
| Zip / unzip files | `APEX_ZIP` | [plsql](reference/plsql/062-APEX_ZIP.md) |

## UI components (server-side region/page/item APIs)

| To… | Use | Ref |
|---|---|---|
| Handle regions programmatically | `APEX_REGION` (server), `apex.region` (client) | [plsql](reference/plsql/048-APEX_REGION.md) · [js](reference/javascript/apex.region.md) |
| Handle pages | `APEX_PAGE` (server), `apex.page` (client) | [plsql](reference/plsql/043-APEX_PAGE.md) · [js](reference/javascript/apex.page.md) |
| Work with Interactive Grids | `APEX_IG` (server), `interactiveGrid` widget (client) | [plsql](reference/plsql/033-APEX_IG.md) · [js](reference/javascript/interactiveGrid.md) |
| Work with Interactive Reports | `APEX_IR` | [plsql](reference/plsql/034-APEX_IR.md) |
| Add application/global search | `APEX_SEARCH` | [plsql](reference/plsql/050-APEX_SEARCH.md) |
| Work with themes / theme styles | `APEX_THEME` (server), `apex.theme` (client) | [plsql](reference/plsql/057-APEX_THEME.md) · [js](reference/javascript/apex.theme.md) |
...
| To… | Use | Ref |
|---|---|---|
| Plug-in interface declarations + helpers | `APEX_PLUGIN`, `APEX_PLUGIN_UTIL` | [plsql](reference/plsql/044-APEX_PLUGIN.md) · [plsql](reference/plsql/045-APEX_PLUGIN_UTIL.md) |
| Emit CSS to HTTP output (plug-ins) | `APEX_CSS` | [plsql](reference/plsql/017-APEX_CSS.md) |
| Emit JavaScript to HTTP output (plug-ins) | `APEX_JAVASCRIPT` | [plsql](reference/plsql/036-APEX_JAVASCRIPT.md) |
...
| Manage the APEX runtime instance | `APEX_INSTANCE_ADMIN` | [plsql](reference/plsql/032-APEX_INSTANCE_ADMIN.md) |
| Export app / file / workspace / feedback definitions | `APEX_EXPORT` | [plsql](reference/plsql/028-APEX_EXPORT.md) |
...
| Work with shared components | `APEX_SHARED_COMPONENT` | [plsql](reference/plsql/053-APEX_SHARED_COMPONENT.md) |
| Manage UI defaults (from SQLcl/SQL Developer) | `APEX_UI_DEFAULT_UPDATE` | [plsql](reference/plsql/058-APEX_UI_DEFAULT_UPDATE.md) |

## Workflow, automation & background work

| To… | Use | Ref |
|---|---|---|
| Manage Workflows | `APEX_WORKFLOW` | [plsql](reference/plsql/061-APEX_WORKFLOW.md) |
| Query-triggered automations (monitor data → act) | `APEX_AUTOMATION` | [plsql](reference/plsql/012-APEX_AUTOMATION.md) |
| Human tasks & approvals | `APEX_HUMAN_TASK` | [plsql](reference/plsql/031-APEX_HUMAN_TASK.md) |
...
| LLM-friendly database metadata descriptions | `APEX_DB_DICTIONARY` | _not in 24.2 (added 26.1+)_ |

## Debugging, errors & diagnostics

| To… | Use | Ref |
|---|---|---|
| Instrument/log debug messages | `APEX_DEBUG` (server), `apex.debug` (client) | [plsql](reference/plsql/023-APEX_DEBUG.md) · [js](reference/javascript/apex.debug.md) |
| Raise/handle errors, custom error handler | `APEX_ERROR` | [plsql](reference/plsql/025-APEX_ERROR.md) |
| Instance-level debug (administrators) | `APEX_INSTANCE_DEBUG` | _not in 24.2 (added 26.1+)_ |

## Printing & document generation

| To… | Use | Ref |
|---|---|---|
| Invoke print servers / generate templated documents | `APEX_PRINT` | [plsql](reference/plsql/046-APEX_PRINT.md) |
